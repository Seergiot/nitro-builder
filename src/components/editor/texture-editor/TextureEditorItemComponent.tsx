...
export const TextureEditorItemComponent: FC<{ textureAssetIndex: number }> = props =>
{
    ...
    const { assets = null, setAssets = null, refreshAssetData } = useNitroBundle();
        ...
        reader.onload = event =>
        {
            ...
            (async () =>
            {
                try
                {
                    ...
                    // Actualizar los assets con la nueva textura
                    setAssets(prevValue =>
                    {
                        if (prevValue[textureAssetIndex] === undefined) return prevValue;
                        ...
                        // Actualizar la textura del asset
                    ...
                    // Generar y actualizar la URL de la textura para la vista previa
                    const sprite = new Sprite(texture);
                    const newTextureUrl = await TextureUtils.generateImageUrl(sprite);
